...
function updateFilters() {
  ...
  //   filteredData = filteredData.filter((row) => row.datetime === date);
    //==================================
    // Object.keys(filters).forEach((filterRow) => {
    //   Object.values(filters).forEach((filterVal) => { 
    //     console.log(filterRow, filterVal);
    //     // filteredData = filteredData.filter((row) => row[filterVal] === filterVal);
    //     // console.log(filteredData);
    //   });
    // });
